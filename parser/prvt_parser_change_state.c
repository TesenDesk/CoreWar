...
static int	prvt_find_parser_op0_state(int token_type)
{
...
static int	prvt_parser_find_next_to_init_st(int token_type)
{
...
static int	prvt_find_1_0_layer_op(t_parser *parser, int token_type)
{
...
static int	prvt_find_1_1_layer_op(t_parser *parser, int token_type)
{
...
static int	prvt_find_2_0_layer_op(t_parser *parser, int token_type)
{
	if (token_type == TOKEN_TREG)
	{
...
static int	prvt_parser_find_next_to_op01_st(t_parser *parser, int token_type)
{
