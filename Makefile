...
#		@gcc $(FLAGS) -o $(ASM_NAME) $(LEX_DIR_SRC) $(LIBFLAGS) -I$(HEADERDIR)
		...
		make -C $(LIBDIR)
		make -C ./ft_printf/
		gcc  -I$(ASM_INTERFACE) -I$(OPERATION_INTERFACE)  -I$(LIBDIR) -I$(LIBPRINT) $^ -o $@ $(LIBFLAGS) $(LIBPRINTFLAGS) -g
...
#		@printf "$(PREFIX)📦  Building $(COREWAR_NAME)...\n"
		make -C ./libft/
		make -C ./ft_printf/
		gcc  -I$(COREWAR_INTERFACE) -I$(LIBDIR) -I$(LIBPRINT)    -I$(OPERATION_INTERFACE)  $^ -lncurses -o $@ $(LIBFLAGS) $(LIBPRINTFLAGS) -g
#$(LIB):
		#make -C libft/

$(VM_DIR_OBJ): %.o: %.c
		gcc $(FLAGS) -I$(COREWAR_INTERFACE) -I$(LIBDIR)  -I$(LIBPRINT)   -I$(OPERATION_INTERFACE)  -c $< -o $@ -g
