...
int				arena_get_n_bytes_from(t_arena *self, int pos,
					int num_of_bytes);
...
void			arena_set_player_index(t_arena *self, int mapcell_index,
					int index);
void			arena_set_store_index(t_arena *self, int mapcell_index,
					int index);
void			arena_set_carriage_num(t_arena *self, int index,
					int carriage_num);
unsigned int	arena_get_player_code_size(t_arena *self, int player_index);
void			arena_set_cell_index(t_arena *self, int mapcell_index,
					int index);
